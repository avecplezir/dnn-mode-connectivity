...
python train.py --dir=curves/curve101 --model=VGG16 --data_path=data --epochs=50 --dataset=CIFAR10

python train.py --dir=curves/curve102 --model=VGG16 --data_path=data --epochs=50 --dataset=CIFAR10
