...
for i, alpha in enumerate(alphas):
    for j, beta in enumerate(betas):
        ...
        tr_res = utils.test(loaders['train'], base_model, criterion, regularizer, cuda=args.cuda)
        te_res = utils.test(loaders['test'], base_model, criterion, regularizer, cuda=args.cuda)
